...
I flatten all the EMA parameters and distribute them equally across all ranks, just like ZeRO-1 and ZeRO-2 of DeepSpeed.
Each rank only update the EMA parameters distributed to it.

I now use a separate distributed CPU group to gather the EMA parameters from all devices.
